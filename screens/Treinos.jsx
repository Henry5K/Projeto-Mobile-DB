...
const TreinosScreen = () => {
  return (
    <Stack.Navigator>
      <Stack.Screen name="Treinos" component={TreinosHomeScreen} options={{ headerShown: false }} />
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.titleContainer}>
        ...
        <Text style={styles.subtitle}>Tipos de planos para você começar a se exercitar</Text>
      </View>
          ...
          <ImageBackground key={index} source={card.image} style={styles.card}>
            ...
            <View style={styles.cardFooter}>
              <Text style={styles.cardFooterText}>
                <FontAwesome5 name={card.icon} style={styles.icon} /> {card.time}
              </Text>
              <Text style={styles.cardFooterText}>
                <FontAwesome5 name="lightbulb" style={styles.icon} /> {card.benefits}
              </Text>
            </View>
